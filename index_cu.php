...
<div class="Container">
    ...
    <script>
        ...
        function tinhcuoc2() 
        {
        	var cuocchieungan, chieungannhanbamuoi,cuocchieudai,tiengiocho,phicaupha,lephikhac,tongsotien;
        	var cuocchieungan2, chieungannhanbamuoi2,cuocchieudai2,tiengiocho2,phicaupha2,lephikhac2,tongsotien2;
        	
        	cuocchieungan = $("#cuocchieungan").val();
        	if (isNaN(cuocchieungan)) {$("#cuocchieungan").val('0');}
        	cuocchieungan2= eval(cuocchieungan);
        			
        	chieungannhanbamuoi = Math.round(cuocchieungan2 * 30/100,0);
        	$("#chieungannhanbamuoi").val(chieungannhanbamuoi);
        
        	
        	if ( $("#cuocchieudai").val().length == 0 ) {cuocchieudai2 =0;} 
        	else 
        	{
        		cuocchieudai = $("#cuocchieudai").val();
        		cuocchieudai2= eval(cuocchieudai);
        	}
        	...
        	tongsotien = chieungannhanbamuoi + cuocchieudai2 + tiengiocho2 + phicaupha2+ lephikhac2;
        	tongsotien2 = tongsotien;
        	tongsotien2 = Math.round(tongsotien2,0)*1000;
        if ($("#cuocchieudai").val().length > 0 && $("#cuocchieungan").val().length > 0) {$("#tongsotien").val(formatkq(tongsotien2)+'đ');} else {$("#tongsotien").val('');}
        }
    </script>
    
        
    <div style="width:100%;border-radius:5px;padding:0px;margin-top:15px;background:white;border:1px solid green;">
        <center>  
            <div style="margin:20px;position:relative;"><center>
        		...
        		<div style="position:absolute;bottom:-18px;left:5px;width:90%;">
    ...
    <div style="width:100%;border-radius:5px;border:1px solid green;margin-top:15px;background:white;color:green;"><center>
    	<div style="border-radius:8px;padding:5px;margin:10px;">
    		<div style="width:90%"><BR>
    			<center><div style="text-align:center;font-weight:bold;">BẢNG TÍNH CUỐC ĐI 2 CHIỀU</div></center>
    			<table width="95%" style="padding:3px;">
    				<tr>
    					<td>
    						<input type="text" class="PVCInput" id="cuocchieungan" maxlength="4" placeholder="Chiều ngắn" onkeyup="tinhcuoc2();"/>
    					</td>
    				...
    				<tr>
    					<td>
    						<input type="text" class="PVCInput" id="cuocchieudai" maxlength="4" placeholder="chiều dài" onkeyup="tinhcuoc2();"/>
    					</td>
    					<td style="width:5px;"></td>
    					<td>
    ...
    <a href="../goixe/">
        <div style="position:fixed;right:20px;bottom:30px;width:45px;height:45px;border-radius:50%;z-index:50;background:white;padding:5px;">
            <img src="../goixe/calling.svg" width="45px">
        </div>
    </a>
    
    
    <div style="text-align:left;">
        <h4><span style="color:rgba(0,0,0,0.6)"> CÔNG TY TNHH MTV MAI LINH NAM ĐỊNH</span></h4>
        <span style="color:rgba(0,0,0,0.6)">
        <img src="../goixe/calling.svg" width="15px"> (0228) 6 252525 hoặc chỉ cần gọi 1055<br>
        Facebook: <a href="http://www.facebook.com/taximailinhnamdinh"><font color="#00a859">taximailinhnamdinh</font></a></span><br>
        
    </div>
    <div style="width:100%;background:green;color:white;text-align:center;"><img src="../goixe/vitri.svg" width="20px"> 186 Thanh Bình - P. Hạ Long - NĐ<br><?php include ($_SERVER['DOCUMENT_ROOT'].'/counters/count_giacuoc.php'); ?></div>
</div>